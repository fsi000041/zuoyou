...
public class SeleteCarActivity extends BaseActivity {
    ...
    private void initData() {
        list.add(new CarEntity("车辆1","编号：001"));
        list.add(new CarEntity("车辆2","编号：002"));
        list.add(new CarEntity("车辆3","编号：003"));
