...
public class SeleteProterActivity extends BaseActivity {
    ...
    private void initData() {
        list.add(new CarEntity("搬运工1", "工号：001"));
        list.add(new CarEntity("搬运工2", "工号：002"));
        list.add(new CarEntity("搬运工3", "工号：003"));
