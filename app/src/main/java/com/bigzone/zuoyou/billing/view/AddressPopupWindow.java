...
import com.bigzone.zuoyou.billing.server.XmlParserHandler;
import com.bigzone.zuoyou.wheel.OnWheelChangedListener;
import com.bigzone.zuoyou.wheel.WheelView;
import com.bigzone.zuoyou.wheel.adapters.ArrayWheelAdapter;
...
public class AddressPopupWindow extends PopupWindow implements OnWheelChangedListener, View.OnClickListener {
    ...
    public AddressPopupWindow(final Context context) {
        super(context);
        this.context = context;
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mView = inflater.inflate(R.layout.popup_address, null);
    ...
    private void showSelectedResult() {
        listener.onReturnAddress(mCurrentProviceName + "," + mCurrentCityName + ","
    ...
    public interface OnGetAddressListener {
        void onReturnAddress(String address);
    }
